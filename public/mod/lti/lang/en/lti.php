...
$string['publickeyset'] = 'Public keyset URL';
$string['publickeyset_help'] = 'Public keyset URL from where this site will retrieve the tool\'s public key to allow signatures of incoming messages and service requests to be verified.';
